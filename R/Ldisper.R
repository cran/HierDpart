...
Ldisper=function(f,ncode,group){
...
dispersion<-betadisper(DeltaDmat, group)
pertestdis=permutest(dispersion, pairwise = TRUE)
return(list(dispersion=dispersion,pertestdis=pertestdis))
